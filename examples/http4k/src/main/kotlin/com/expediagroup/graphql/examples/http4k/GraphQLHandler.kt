...
import com.expediagroup.graphql.examples.http4k.schema.BookQueryService
import com.expediagroup.graphql.examples.http4k.schema.CourseQueryService
import com.expediagroup.graphql.examples.http4k.schema.HelloQueryService
import com.expediagroup.graphql.examples.http4k.schema.LoginMutationService
import com.expediagroup.graphql.examples.http4k.schema.UniversityQueryService
import com.expediagroup.graphql.examples.http4k.schema.models.BATCH_BOOK_LOADER_NAME
import com.expediagroup.graphql.examples.http4k.schema.models.COURSE_LOADER_NAME
import com.expediagroup.graphql.examples.http4k.schema.models.UNIVERSITY_LOADER_NAME
import com.expediagroup.graphql.examples.http4k.schema.models.User
import com.expediagroup.graphql.examples.http4k.schema.models.batchBookLoader
import com.expediagroup.graphql.examples.http4k.schema.models.batchCourseLoader
import com.expediagroup.graphql.examples.http4k.schema.models.batchUniversityLoader
...
class GraphQLHandler {
    companion object {
        ...
        val graphQL = GraphQL.newGraphQL(toSchema(config, queries, mutations)).build()!!
    }
    ...
    private fun getPayload(request: Request): Map<String, Any>? {
        return try {
            mapper.readValue<Map<String, Any>>(request.bodyString())
        } catch (e: IOException) {
