...
import com.expediagroup.graphql.examples.http4k.schema.context.UserDbHandler
import com.expediagroup.graphql.examples.http4k.schema.simple.BookDbHandler
...
fun main() {
    Http4kGraphQLApp().asServer(SunHttp(5000)).start()
}
